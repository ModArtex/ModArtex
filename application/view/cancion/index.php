<div class="container">
    ...
    <div class="box">
        <h3>Add a song</h3>
        <form action="<?php echo URL; ?>cancion/addsong" method="POST">
            <label>Artist</label>
        ...
        <table>
            ...
            <?php foreach ($songs as $song) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo URL . 'cancion/deletesong/' . htmlspecialchars($song->id, ENT_QUOTES, 'UTF-8'); ?>">delete</a></td>
                    <td><a href="<?php echo URL . 'cancion/editsong/' . htmlspecialchars($song->id, ENT_QUOTES, 'UTF-8'); ?>">edit</a></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
